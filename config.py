...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/kohlironey292-lab/RONEY",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/shayari_A")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+3atCLGqBvhliNjM9")
